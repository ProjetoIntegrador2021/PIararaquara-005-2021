          ...
          <div class="modal-body">
             ...
             <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" name="nome" placeholder="Nome da Produto" value="@if($errors->has('nome')) {{old('nome')}} @else {{$peca->nome}} @endif">
                    @if($errors->has('nome'))
